...
(function () {
  ...
  var HTML =
    ...
    '        <img src="/images/brand/logo-dual-f.png" alt="" width="48" height="48" style="width:48px;height:48px;object-fit:contain;filter:drop-shadow(0 2px 4px rgba(0,0,0,0.45));flex-shrink:0;" />' +
    ...
    '        <a href="/wa" class="ff-pillar ff-pillar-find" title="Step 1 · State Directory → County Selection → City Code Compliancy → Community / HOA Bylaws">' +
    ...
    '          <a href="/homeowner" class="ff-account-item"><span>🏡</span><div><span class="ff-account-title" style="color:#4ADE80;">Fence Founder (Homeowners)</span><span class="ff-account-sub">Saved Fence-Folios &amp; 3-Bid Tracker</span></div></a>' +
    '          <a href="/contractors-hub.html" class="ff-account-item"><span>🔨</span><div><span class="ff-account-title" style="color:#F27A22;">Fence Fabricator (Contractors)</span><span class="ff-account-sub">72-Hr Job Feed &amp; Live SMS Bids</span></div></a>' +
    '          <a href="/geo-community.html" class="ff-account-item"><span>🏛️</span><div><span class="ff-account-title" style="color:#E5B842;">Fence Facilitator (HOA-Rep)</span><span class="ff-account-sub">ARC Committee Portal &amp; Bylaw Standards</span></div></a>' +

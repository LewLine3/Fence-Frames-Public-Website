        ...
        {tripled.map((card, idx) => {
          ...
          if (card.type === 'swatch') {
            return (
              ...
              >
                <div className="flex items-center justify-between pb-1 border-b border-white/10 text-xs w-full">
                  <div className="flex items-center gap-1.5">
                    {card.colorPreview && (
                      <span
                    ...
                    <span
                      className={`font-bold uppercase tracking-wide text-[10px] truncate max-w-[110px] ${
                        card.selected ? 'text-[#E5B842]' : 'text-white'
                      }`}
                    >
                      {card.title}
                    </span>
                  ...
                  <span
                    className={`text-[8px] font-mono px-1 py-0.2 rounded font-bold ${
                      card.selected
                        ...
                        : 'bg-black/50 text-[#4ADE80] border border-[#4ADE80]/30'
                    }`}
                  >
                    {card.cost}
                  </span>
                ...
                <div className="py-1 text-[8px] text-white/70 line-clamp-2 leading-tight">
                  {card.description}
                </div>

                <div className="pt-1 border-t border-white/10 flex items-center justify-between text-[7px]">
                  <span className="text-white/50">{card.subtitle}</span>
                  <span
            ...
            return (
              ...
              >
                ...
                <div className="pt-0.5 border-t border-white/10 flex items-center justify-between text-[7px] text-white/60">
                  <span>
                    Stain: <strong className="text-white">{config.stainType.split('-')[0]}</strong>
                  </span>
                  <span>
                    Gates:{' '}

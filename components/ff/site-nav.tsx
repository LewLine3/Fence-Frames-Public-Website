  ...
  return (
    <header className="nav">
      <div className="wrap nav-inner" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "1rem" }}>
        ...
        {/* Left: Brand Wordmark + 3 Tucked-Left Dark Pillar Buttons */}
        <div className="nav-left-suite">
          <a className="brand" href="/" aria-label="Fence Frames home" style={{ display: "flex", alignItems: "center", gap: "10px", textDecoration: "none" }}>
            <span className="home-ico" aria-hidden="true" style={{ width: "34px", height: "34px", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <img src="/images/fence-frames-logo-icon.svg" alt="Fence Frames Icon" style={{ width: "34px", height: "34px", objectFit: "contain", filter: "drop-shadow(0 2px 4px rgba(0,0,0,0.5))" }} />
            </span>
            <span className="name">
              <span className="nav-fence" style={{ color: "#4ADE80" }}>Fence</span>&nbsp;<span className="nav-frames" style={{ color: "#E5B842" }}>Frames</span>
            </span>
          </a>

          {/* 3 Dark Box Pillar Buttons (Canon Phase Colors) */}
          <nav className="nav-pillar-group hidden sm:flex">
            <a href="/geo-north-bend.html" className="nav-pillar-box nav-pillar-find" title="Step 1 · Code & HOA Matcher">
              <span className="nav-pillar-dot"></span>
            ...
            <a href="/blueprint-standalone.html" className="nav-pillar-box nav-pillar-fence" title="Step 3 · Blueprints & Takeoff Ledger">
              <span className="nav-pillar-dot"></span>
        ...
        {/* Right: Accounts Dropdown + Action CTA */}
        <div className="nav-end" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <div className="nav-accounts-wrapper">
            ...
            <div className="nav-accounts-menu">
              <div style={{ padding: "4px 8px 6px", borderBottom: "1px solid rgba(255,255,255,0.1)", fontSize: "10px", color: "#E5B842", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em" }}>
                Select Account Portal
              </div>
              <a href="/homeowner-dashboard.html" className="nav-account-item">
                <span className="account-icon">🏡</span>
                <div>
                  <span className="account-title" style={{ color: "#4ADE80" }}>Homeowner Account</span>
              ...
              <a href="/contractors-hub.html" className="nav-account-item">
                <span className="account-icon">🔨</span>
                <div>
                  <span className="account-title" style={{ color: "#F27A22" }}>Contractor Account</span>
              ...
              <a href="/geo-si-view.html" className="nav-account-item">
                ...
                <div>
                  <span className="account-title" style={{ color: "#E5B842" }}>HOA Official Account</span>
              ...
              <a href="/auth-gate.html" className="nav-account-item">
                <span className="account-icon">🔑</span>
                <div>
                  <span className="account-title" style={{ color: "#FAF6EE" }}>Sign In / Switch Role</span>

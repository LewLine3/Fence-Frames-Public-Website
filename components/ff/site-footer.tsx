  ...
  return (
    <footer style={{ backgroundColor: "var(--forest-deep)", color: "#FAF6EE", padding: "2.5rem 3rem 1.5rem 3rem", marginTop: "2rem" }}>
        ...
        >
          ...
          <div style={{ flexGrow: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem" }}>
            ...
            >
              ...
              <h2 style={{ ...rowdies(700), fontSize: "3rem", color: "var(--gold-sun)", margin: 0, lineHeight: 1, letterSpacing: "0.02em" }}>
                Fence Frames
              </h2>
      ...
      >
        ...
        <div style={{ ...rowdies(300), fontSize: "0.85rem", color: "#A0B2A6" }}>Fence Frames is a design &amp; introduction service, not a contractor.</div>
      </div>
    </footer>
  )
}
